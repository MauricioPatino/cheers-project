...
void _customerSerialize(
  ...
  writer.writeString(offsets[0], object.customer);
}
...
Customer _customerDeserialize(
  ...
  object.customer = reader.readStringOrNull(offsets[0]);
  object.id = id;
  return object;
}
...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerEqualTo(
    String? value, {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'customer',
        value: '',
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> customerIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'customer',
        value: '',
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByCustomer() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customer', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByCustomerDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByCustomer() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customer', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByCustomerDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customer', Sort.desc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByCustomer(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, String?, QQueryOperations> customerProperty() {
    return QueryBuilder.apply(this, (query) {
